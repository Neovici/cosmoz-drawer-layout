import{i as e}from"./preload-helper-usAeo7Bx.js";import{W as t}from"./iframe-CVfikaYd.js";import{i as n,n as r,r as i,t as a}from"./cosmoz-side-panel-B4iVBNUa.js";var o,s,c,l,u,d,f;e((()=>{n(),i(),r(),a(),o={title:`SidePanel`,component:`cosmoz-side-panel`,tags:[`autodocs`],argTypes:{drawerMode:{control:`select`,options:[`overlay`,`side`],description:`Container mode — set via --_drawer-mode CSS custom property by the parent layout`}},args:{}},s={argTypes:{drawerMode:{control:`select`,options:[`overlay`,`side`]}},args:{drawerMode:`overlay`},render:e=>t`
        <div style="width: 300px; height: 400px; border: 1px solid #ddd;">
            <cosmoz-side-panel style="--_drawer-mode: ${e.drawerMode}">
    ...
    `},d={parameters:{layout:`fullscreen`},render:()=>t`
        <style>
            .part-styling-story {
                position: absolute;
                top: 0;
  ...
  render: () => html\`
    ...
    \`
}`,...d.parameters?.docs?.source}}},f=[`Default`,`Bordered`,`BorderedInDrawerLayout`,`CustomBorders`,`PartStyling`]}))();export{c as Bordered,l as BorderedInDrawerLayout,u as CustomBorders,s as Default,d as PartStyling,f as __namedExportsOrder,o as default};